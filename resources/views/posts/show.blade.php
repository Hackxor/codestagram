...
@section('contenido')
    <div class="container mx-auto md:flex ">
        <div class="md:w-1/2">
            <img src="{{asset('uploads' . '/' . $post->imagen)}}" alt="Imagen de la publicacion">
            ...
            @auth
            {{-- la persona que esta autenticada es la misma del post? --}}
...
{{-- caja de comentarios --}}
        <div class="md:w-1/2 p-5">
            <div class="shadow bg-white p-5 mb-5">
                ...
                @endauth
                <div class="shadow bg-white mb-5 max-height-96 overflow-y-scroll mt-10">
