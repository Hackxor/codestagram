...
<html>
    ...
    <body class="bg-gray-100">
        ...
        <div class="container mx-auto flex justify-between items-center">
             <a href="{{route('home')}}" class="text-3xl font-black">Codestagram</a>
            {{-- verificando si el usuario esta autenticado y mostrar barras de navegacion --}}
             @auth
             <nav class="flex gap-2 items-center">
                ...
                {{-- añadiendo seguridad al cerrar sesion --}}
        ...
        <footer class="text-center p-5 text-gray-500 font-bold uppercase">
            Codestagram - todos los derechos reservados {{ now()->year }}
        </footer>
